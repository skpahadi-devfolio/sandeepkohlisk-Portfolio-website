...
const Projects = () => {
  ...
  const [projects, setprojects] = useState([
    ...
    {
      title: "Smart Grihini - House Management System",
      desc: "Developed a full-stack house management and personal finance mobile application using React Native, Express.js, Node.js, and PostgreSQL. Integrated JWT Authentication for secure user registration and session management. Features include an interactive expense and budget tracker, Daily meal planner, and a household task manager. Designed secure RESTful APIs to deliver a responsive, mobile-first experience.",
      end: ["React Native", "Express.js", "Node.js", "Neon PostgreSQL", "JWT"],
      Link: "https://github.com/skpahadi-devfolio/HouseManagement-System/releases/latest"
    },
    {
        ...
        return (
          <ScaleIn>
            <div key={index} className='my-12 p-5 w-full max-w-5xl mx-auto flex flex-col gap-3 text-white bg-gradient-to-br from-[#040005] via-[#0a0011] to-[#11041b] text-xs md:text-base'>
              ...
              <p className='text-blue-900 bg-green-600 w-[35vw] font-bold max-w-3xs text-center p-2 rounded-md'><a href={item.Link} target='_blank'>View Project</a></p>
            </div>
          </ScaleIn>
        )
      })}
